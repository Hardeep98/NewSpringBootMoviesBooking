					...
					<div class="card card-outline-secondary">
							...
							<form:form action="${payment }" class="form" method="post"
								...
								<div class="col-md-6">
									<input type="Date"  name="bookingDate"
										...
										title="movie_date" required=""
										placeholder="movie date">
								</div>
								<div class="col-md-6">
									<input type="number" class="form-control" autocomplete="off"
										maxlength="3" pattern="\d{2}" name="numberoftickets"
										title="Number Of Tickets" required=""
						...
						<div class="form-group">
							<label for="cc_name">Card Holder's Name</label> <input
								type="text" class="form-control" name="nameOnCard" id="cc_name"
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<input type="Date"  name="expirayDate"
									class="form-control" autocomplete="off"
									title="Three digits at back of your card" required=""
									placeholder="Select Expiry Date Date" inputmode="text">
							</div>
							<div class="col-md-4">
